...
public final class Constants {
    ...
    /**Aceleraci�n minima de un jugador al hacer un cambio de direccion en el eje Y**/
    public static final double ACELERACION_MINIMA_Y = 0.70;
    /**Aceleraci�n minima de un jugador al hacer un cambio de direccion en el eje X**/
